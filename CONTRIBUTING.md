...
b) use `go run main.go` to run lazyapple
...
b) use `go run -mod=vendor main.go` to run lazyapple
c) if you need to bump a dependency e.g. jesseduffield/gocui, use
...
[code of conduct]: https://github.com/g-battaglia/lazy-apple-container/blob/master/CODE-OF-CONDUCT.md
...
## Report bugs using Github's [issues](https://github.com/g-battaglia/lazy-apple-container/issues)

We use GitHub issues to track public bugs. Report a bug by [opening a new
issue](https://github.com/g-battaglia/lazy-apple-container/issues/new); it's that easy!
