...
func turkishSet() TranslationSet {
	return TranslationSet{
		...
		ConnectionFailed:                  "Apple Container bağlantısı başarısız oldu. 'container' CLI'nin kurulu olduğunu kontrol edin",
		UnattachableContainerError:        "Konteyner attaching modunda çalışmayı desteklemiyor. İnteraktif shell açmak için 'exec shell' ('E' tuşu) kullanın.",
		...
		CannotAccessRuntimeError:          "Apple Container runtime'a bağlanılamıyor.\n'container' CLI'nin kurulu ve çalışır durumda olduğundan emin olun.",
		...
		EditConfig:         "lazyapple ayarlarını düzenle",
		Cancel:             "iptal",
		Remove:             "kaldır",
		...
		ConfigTitle:               "Ayarlar",
		EnvTitle:                  "Env",
		ComposeConfigTitle:        "Konteyner Ayar",
		TopTitle:                  "Top",
		StatsTitle:                "Durumlar",
